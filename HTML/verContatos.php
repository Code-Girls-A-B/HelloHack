...
<body>
    ...
    <section class="conteudo-visualizar">
        <section class="conteudo-visualizar-box">
            <h1>Contatos dos Usuarios</h1>
            <?php
                $listaContato = retornaContato();
                while($contato = mysqli_fetch_assoc($listaContato))
                {
                    echo "<section class=\"conteudo-bloco\">";
                    echo "<h2>" . $contato["nome"] . "</h2>";
                    echo "<p>E-mail: " . $contato["email"] . "</p>";
                    echo "<p>Mensagem: " . $contato["mensagem"] . "</p>";
                    echo "</section>";
                }
            ?>
        </section>
