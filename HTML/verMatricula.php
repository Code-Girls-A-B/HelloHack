...
<body>
    ...
    <section class="conteudo-visualizar">
        <section class="conteudo-visualizar-box">
            <h1>Informações de matrícula dos alunos</h1>
            <?php
                $listaCurso = retornaCurso();
                while($curso = mysqli_fetch_assoc($listaCurso))
                {
                    echo "<section class=\"conteudo-bloco\">";
                    echo "<h2>" . $curso["nomeAluno"] . "</h2>";
                    echo "<p>nomeCurso: " . $curso["nomeCurso"] . "</p>";
                    echo "<p>email: " . $curso["email"] . "</p>";
                    echo "<p>cpf: " . $curso["cpf"] . "</p>";
                    echo "<p>numero de Celular: " . $curso["numeroCelular"] . "</p>";
                    echo "<p>forma de pagamento: " . $curso["pagamento"] . "</p>";
                    echo "</section>";
                }
            ?>
        </section>
