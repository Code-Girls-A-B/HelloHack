...
<head>
    ...
    <title>Cursos HelloHack - Criptografia</title>
</head>
    ...
    <main class="container">
      ...
      <div class="right-column">
        ...
        <div class="product-description">
          ...
          <h1>Criptografia</h1>
          <p>A criptografia desempenha um papel fundamental na proteção de dados sensíveis em diferentes contextos, como transações financeiras, comunicações online e armazenamento em nuvem. </p>
        </div>
